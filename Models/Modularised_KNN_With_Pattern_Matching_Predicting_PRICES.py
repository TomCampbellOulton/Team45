...
from model_utils import build_result_df, compute_rmse, generate_future_dates, generate_trading_dates
...
def main(START_DATE="2010-01-01", END_DATE="2025-12-31",
    ...
    # Predict future rows if available and FUTURE_STEPS > 0
    ...
    if n_future > 0 and FUTURE_STEPS > 0:
        ...
        if future_pred_list:
            ...
            future_target_dates = generate_future_dates(last_test_date, len(future_pred_list), N_STEPS)
            ...
            future_df = build_result_df(future_combined,
                                        ...
                                        idx=future_target_dates,   #df_full.index[-min_f:],
                                        seed_open=seed_open,
                                        n_steps=N_STEPS,
